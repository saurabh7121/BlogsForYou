    ...
    <>
      ...
      `}</style>
        ...
        <div className="w-full max-w-md p-8 space-y-6 bg-gray-900/80 backdrop-blur-sm rounded-lg shadow-2xl border-4 border-dashed border-yellow-500 text-center animate-slideInUp">
            ...
            <p className="font-construction text-gray-400 -mt-4 uppercase tracking-widest">Account Creation</p>

            <form onSubmit={onSubmit} className="space-y-6">
                {error && <p className="text-red-400 text-center bg-red-900/50 border border-red-500/50 py-2 rounded-md">{error}</p>}
                <div>
